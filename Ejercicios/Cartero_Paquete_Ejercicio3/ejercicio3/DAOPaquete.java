...
public class DAOPaquete {
	...
	//**********SENTENCIAS SQL**********//
	private static final String LISTAR_P = "SELECT * FROM PAQUETES";
		
	private static final String INSERTAR_P = "INSERT INTO PAQUETES (IDPAQUETE, CODIGO, PESO, IDCARTERO) VALUES (?,?,?,?)";
		
	private static final String ELIMINAR_P = "DELETE FROM PAQUETES WHERE IDPAQUETE = ?";
		
	private static final String MODIFICAR_P = "UPDATE PAQUETES SET CODIGO=?, PESO=?, IDCARTERO=? WHERE IDPAQUETE = ?";
		
	private static final String MAX_IDPAQUETE="SELECT MAX(IDPAQUETE)FROM PAQUETES";
		
	private static final String BUSCAR_CODIGO="SELECT * FROM PAQUETES WHERE CODIGO=?";
		
	private static final String BORRAR_TODO="DELETE FROM PAQUETES";
	
	private static final String CONSULTA = "SELECT COUNT(*) AS CANTIDAD FROM PAQUETES WHERE IDCARTERO=?";
	//**********FIN SENTENCIAS SQL**********//
